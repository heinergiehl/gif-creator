...
keywords:
  ...
  - best animated image format
  - transparent animation format
relatedSlugs:
...
GIF is still the most recognized animated image format, but it is not always the best output. In many workflows, animated WebP or APNG can preserve better quality or transparency.

If you want to create or edit an animation first, start in the [GIF editor](/edit-gifs). If your input is a video, you can also begin with [video to GIF](/video-to-gif).
...
If transparency is your main concern, continue with [how to make a transparent GIF from video or images](/blog/make-a-transparent-gif-from-video-or-images).
