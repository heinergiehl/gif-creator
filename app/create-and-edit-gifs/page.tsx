...
export const metadata: Metadata = {
  title: 'Free Online GIF Editor - Create & Edit Animated GIFs | GifMagic.app',
  description:
    'Create and edit animated GIFs with our powerful online editor. Resize, crop, rotate, add text, optimize, and apply effects to your GIFs. Frame-by-frame editing, high-quality output, and no watermarks. Perfect for social media, marketing, and personal projects. Start creating your animated masterpiece today!',
              ...
              <div className="flex max-w-6xl flex-col items-center justify-center gap-x-2 px-4">
                <NeonGradientCard className="mt-[170px] flex items-center justify-center">
                  <h1 className="pointer-events-none z-10 w-full bg-gradient-to-br from-[#ff2975] from-35% to-[#00FFF1] bg-clip-text text-center text-7xl font-bold leading-none tracking-tighter text-transparent dark:drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
                    Professional GIF Editor by GifMagic
                  </h1>
                </NeonGradientCard>
                <p className="max-w-6xl text-pretty px-4 py-6 text-center text-xl md:px-0">
                  Welcome to GifMagic, the advanced online GIF editor with professional tools. Resize animated GIFs, crop regions, rotate images, edit frames, add text, optimize file sizes, and more. All processing is done locally in your browser for complete privacy.
                </p>
