        ...
        >
          ...
          <div className="flex h-full w-screen flex-col  items-center justify-center md:w-full">
            ...
            >
              <CustomAlertDialog />
              <div
                className="relative  flex   w-full flex-col items-start justify-start  md:h-[calc(100vh-50px)] md:w-full"
                draggable="false"
              >
                <ScrollArea className="m-auto  flex h-[calc(100vh-200px)]   flex-col items-center justify-center  gap-y-2 rounded-none md:h-full md:flex-row">
