      ...
      >
        ...
        >
          ...
          <div className="flex h-full w-screen flex-col  items-center justify-center md:w-full">
            <EditResource />
            <div
              className="flex h-screen w-screen  flex-col items-center justify-center md:w-full"
              id="editor-container"
            >
              <CustomAlertDialog />
              <div
                className="relative  flex   w-full flex-col items-start justify-start  md:h-[calc(100vh-90px)] md:w-full"
                draggable="false"
              >
                <ScrollArea className="m-auto  flex h-[calc(100vh-90px)]   flex-col items-center justify-center  gap-y-2 rounded-none md:h-full md:flex-row">
                  ...
                  {/* RESOURCES */}
                  <ScrollArea className="h-[80vh]  w-screen  md:hidden">
                    {' '}
                    <Resources />
                  </ScrollArea>
