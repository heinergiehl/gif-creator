          ...
          <div className="flex h-full w-screen flex-col  items-center justify-center md:w-full">
            ...
            >
              ...
              <div
                ...
                draggable="false"
              >
                <ScrollArea className="m-auto flex h-[calc(100svh-50px)] w-[95%] flex-col items-center justify-center gap-y-2  rounded-none p-4 md:h-full md:flex-row">
                  ...
                  <ScrollArea className="h-[15vh] w-[95%] p-4" draggable="false">
                    <EditorCarousel containerWidth={containerWidth} />
                    <ScrollBar orientation="vertical" />
                  </ScrollArea>
                  {/* RESOURCES */}{' '}
                  <ScrollArea className="h-[320px] w-[95%] p-4">
                    <Resources />
                    <ScrollBar orientation="vertical" />
                  </ScrollArea>
