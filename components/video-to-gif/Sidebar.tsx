...
export const Sidebar = observer(() => {
  ...
  return (
    <div className="absolute bottom-0 left-0 flex w-screen items-center justify-start dark:bg-gray-800  md:top-0 md:h-screen  md:w-[90px]   md:flex-col md:pt-[50px]">
